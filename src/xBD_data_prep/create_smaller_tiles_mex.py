...
os.chdir('/media/julian/Extreme Pro/xbd')

config = {
    'batch_size': 1,
    'data_dir': 'geotiffs/',
    'sliced_data_dir': 'disaster_split2/',
    'disaster_splits_json': 'all_disaster_splits.json',
    'disaster_splits_json_sliced': 'final_mdl_all_disaster_splits_sliced_img_augmented_20.json'
}
...
def load_dataset():
    ...
    for disaster_name, splits in splits_all_disasters.items():
        if disaster_name != 'mexico-earthquake': continue
